...
/**
 * DTO (Data Transfer Object) que representa la solicitud de actualización de
 * una cuenta.
 *
 * <p>
 * <strong>¿Qué es?</strong><br>
 * Es un objeto que encapsula los datos que el cliente (frontend) envía al
 * servidor
 * para modificar la información de una cuenta existente.
 *
 * <p>
 * <strong>¿Para qué sirve?</strong><br>
 * Sirve para recibir y validar solo los campos que el usuario final puede
 * editar,
 ...
 * El controlador REST recibe un objeto JSON en el cuerpo de la petición HTTP
 * (PUT/PATCH),
 * lo deserializa a {@code UpdateAccountRequest} y aplica las validaciones de
 * Bean Validation
 * ({@code @NotBlank}, {@code @Email}, {@code @Size}) automáticamente.
 * Si pasa las validaciones, se pasa al caso de uso {@code UpdateAccountUseCase}
 * para procesar.
 *
 * <p>
 ...
 *
 * <p>
 * <strong>Nota de diseño:</strong> El ID de la cuenta NO está incluido en este
 * DTO,
 * se recibe por separado como variable de ruta {@code @PathVariable} en el
 * controlador.
 *
...
public class UpdateAccountRequest {
   ...
   * Obligatorio. Mínimo 1 carácter, máximo 50.
   *
   * //TODO: Considerar agregar validación de caracteres especiales (ej. evitar
   * números o símbolos no permitidos)
   */

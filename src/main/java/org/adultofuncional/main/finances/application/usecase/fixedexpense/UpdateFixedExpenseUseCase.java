 ...
 *
 * <p>Esta clase implementa la lógica de actualización dentro de la capa de
 ...
 * automática mediante {@code @RequiredArgsConstructor}.</p>
 *
 ...
 * retornando una vista actualizada del recurso.</p>
 *
 * <p><b>¿Cómo funciona?</b><br>
 * El método {@code execute} implementa el siguiente flujo operativo:</p>
 * <ol>
 ...
 *       en el {@link UpdateFixedExpenseRequest} están presentes (no nulos o con texto).</li>
 ...
 *   <li>Persiste los cambios y transforma el resultado a {@link FixedExpenseResponse}.</li>
 * </ol>
 *
...
public class UpdateFixedExpenseUseCase {
    ...
    // TODO: Evaluar si el accountId recibido debe validarse contra el propietario real del gasto fijo
    /**
     * Ejecuta la lógica de actualización del gasto fijo con los datos proporcionados.
     *
     * <p>La operación se realiza bajo un contexto transaccional, asegurando que
     ...
     * rollback automático de la operación.</p>
     *
     * @param accountId identificador UUID de la cuenta (usado para contexto de seguridad).
     * @param expenseId identificador UUID del gasto fijo que se desea modificar.
     * @param request objeto {@link UpdateFixedExpenseRequest} con los nuevos valores.

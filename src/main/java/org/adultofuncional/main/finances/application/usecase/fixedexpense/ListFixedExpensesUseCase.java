 ...
 *
 * <p>Esta clase implementa el caso de uso de listado de gastos fijos dentro
 ...
 * resultante como una colección de {@link FixedExpenseResponse}.</p>
 *
 ...
 * </ol>
 * <p>La anotación {@code @Transactional(readOnly = true)} optimiza la operación
...
public class ListFixedExpensesUseCase {
     ...
     *
     * <p>Valida primero la existencia de la cuenta, recupera todos sus gastos
     ...
     * resultantes en {@link FixedExpenseResponse} y retorna la lista.</p>
     *
     * <p>El filtrado por término de búsqueda se realiza de forma insensible a
     ...
     *                  {@code null}, en cuyo caso se retornan todos los gastos fijos

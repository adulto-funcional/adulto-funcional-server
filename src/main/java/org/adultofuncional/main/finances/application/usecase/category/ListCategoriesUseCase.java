 ...
 *
 * <p>
 * Esta clase implementa el caso de uso de listado de categorías dentro
 ...
 * de los resultados a la respuesta esperada por el invocador.
 * </p>
 *
 * <p>
 * <b>¿Qué es?</b><br>
 ...
 * las filtra por tipo según los criterios definidos en el
 * {@link CategoryFilterRequest}.
 * Retorna la lista resultante como una colección de {@link CategoryResponse},
 * lista para ser consumida por las capas superiores.
 * </p>
 *
 * <p>
 ...
 * al motor de persistencia que no habrá escrituras durante su ejecución.
 * </p>
 *
...
public class ListCategoriesUseCase {
   ...
   *
   * <p>
   * Recupera la totalidad de las categorías registradas en el sistema
   ...
   * y retorna la lista completa al invocador.
   * </p>
   *
   * <p>
   * El filtrado por tipo se aplica únicamente cuando el parámetro
   * {@code filter} no es {@code null} y su campo {@code type} contiene
   * un valor definido. Si el filtro es {@code null} o su tipo es
   * {@code null}, se retornan todas las categorías sin distinción.
   * </p>
   *
   * <p>
   ...
   * @return lista de {@link CategoryResponse} con los datos de todas las
   *         categorías

 ...
 *
 * <p>
 * Esta clase implementa el caso de uso de obtención de un gasto fijo
 ...
 * del error de forma descriptiva.
 * </p>
 *
 * <p>
 ...
 * {@code orElseThrow}, lo que lanza automáticamente una
 ...
 * aplicar optimizaciones de rendimiento en la sesión de base de datos.
 * </p>
 *
...
public class GetFixedExpenseUseCase {
     ...
     *
     * <p>
     * Busca el gasto fijo en el repositorio mediante su identificador único.
     ...
     * datos completos del gasto fijo recuperado desde la capa de persistencia.
     * </p>
     *
     * <p>
     * La fecha de cierre del gasto fijo se obtiene del campo
     ...
     * La categoría se retorna como {@code null} en esta respuesta.
     * </p>
     *
     * <p>
     ...
     *                           con el identificador {@code expenseId}
     *                           proporcionado.
     */

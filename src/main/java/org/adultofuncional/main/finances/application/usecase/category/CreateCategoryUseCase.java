 ...
 *
 * <p>
 * Esta clase implementa el caso de uso de creación de categorías dentro
 * de la capa de aplicación, orquestando la lógica necesaria para construir
 * la entidad de dominio, persistirla y retornar la respuesta al invocador.
 * </p>
 *
 * <p>
 * <b>¿Qué es?</b><br>
 ...
 * Recibe una solicitud de creación de categoría validada, delega la
 * construcción
 ...
 * datos de la categoría recién creada.
 * </p>
 *
 * <p>
 ...
 * {@link CategoryRepository#save(Category)}, y construye el
...
public class CreateCategoryUseCase {
   ...
   *
   * <p>
   * Orquesta el flujo completo de creación: construye la entidad de dominio
   * mediante el método de fábrica
   * {@link Category#create(String, org.adultofuncional.main.finances.domain.enums.CategoryType)},
   ...
   * incluyendo el identificador único y la fecha de creación.
   * </p>
   *
   * <p>

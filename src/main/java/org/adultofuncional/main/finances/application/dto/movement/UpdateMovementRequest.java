 ...
 *
 * <p>
 * Esta clase encapsula los datos que el cliente puede enviar para modificar
 ...
 * parciales donde solo se envían los campos que se desean modificar.
 * </p>
 *
 * <p>
 * <b>¿Qué es?</b><br>
 ...
 * que lo requieren, sin forzar la presencia de ninguno.
 * </p>
 *
 * <p>
 ...
 * como sin cambios, habilitando actualizaciones parciales (PATCH).
 * </p>
 *
 * <p>
...
public class UpdateMovementRequest {
   ...
   * Si es {@code null}, el tipo del movimiento permanece sin cambios.
   * </p>
   */
   ...
   *
   * <p>
   * Campo opcional. Si se proporciona, reemplaza el monto actual del
   ...
   * de tipos flotantes. Si es {@code null}, el monto permanece sin cambios.
   * </p>
   *
   * <p>
   ...
   *
   * <p>
   * Campo opcional. Si se proporciona, reemplaza la fecha actual del
   ...
   *
   * <p>
   * Campo opcional. Si se proporciona, reemplaza la descripción actual
   ...
   * Si es {@code null}, la descripción del movimiento permanece sin cambios.
   * </p>
   *
   * <p>
   * <b>Restricciones aplicadas cuando el valor es proporcionado:</b>
   ...
   * Si es {@code null}, la categoría del movimiento permanece sin cambios.
   * </p>
   */

 ...
 *
 * <p>
 * Esta clase implementa el caso de uso de actualización de categorías
 ...
 * exclusivamente la lógica del caso de uso "actualizar categoría". Es
 * gestionado
 ...
 * modificada y construye el {@link CategoryResponse} con los datos
 * actualizados.
 * La anotación {@code @Transactional} garantiza la integridad de toda
 * la operación dentro de una única transacción de base de datos.
 * </p>
 *
...
public class UpdateCategoryUseCase {
   ...
   *
   * <p>
   * Busca la categoría por su identificador único y aplica selectivamente
   ...
   * la entidad y retorna su representación actualizada.
   * </p>
   *
   * <p>
   * La verificación del nombre se realiza con {@link StringUtils#hasText},
   ...
   * @param request    objeto {@link UpdateCategoryRequest} que contiene los
   *                   campos

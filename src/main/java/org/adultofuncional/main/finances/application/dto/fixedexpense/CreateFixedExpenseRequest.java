 ...
 * de entrada en el caso de uso de creación de gastos fijos.</p>
 *
 * <p><b>¿Qué es?</b><br>
 ...
 * formateados y validados antes de ser procesados por el sistema.</p>
 *
...
public class CreateFixedExpenseRequest {
     ...
     *
     * <p>Identifica de forma legible el gasto recurrente dentro del sistema
     * (por ejemplo: "Netflix", "Arriendo", "Gimnasio").</p>
     *
     ...
     *
     * <p>Campo obligatorio que define cada cuánto tiempo se genera el gasto,
     * según el enumerado {@link Frequency}
     * (por ejemplo: diario, semanal, mensual, anual, entre otros).</p>
     *
     * <p><b>Restricciones aplicadas:</b></p>
     * <ul>
     ...
     *
     * <p>Campo obligatorio que representa el valor económico del gasto recurrente.
     ...
     *
     * <p>Campo obligatorio que indica la situación operativa del gasto recurrente
     * según el enumerado {@link Status}
     * (por ejemplo: activo, pausado, cancelado, entre otros).</p>
     *
     * <p><b>Restricciones aplicadas:</b></p>
     * <ul>
     ...
     *
     * <p>Campo obligatorio que indica hasta cuándo estará vigente el gasto
     * recurrente. Debe ser una fecha posterior a la actual, garantizando
     * que no se registren gastos con vigencia ya vencida.</p>
     *
     * <p><b>Restricciones aplicadas:</b></p>
     * <ul>
     ...
     *
     * <p>Campo opcional que permite vincular el gasto fijo con una categoría
     * existente en el sistema para facilitar su clasificación y análisis.
     * Si es {@code null}, el gasto fijo se registra sin categoría asociada.</p>
     */

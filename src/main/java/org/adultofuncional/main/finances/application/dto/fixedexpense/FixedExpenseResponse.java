 ...
 *
 * <p>Esta clase encapsula la información completa de un gasto fijo que
 ...
 * anidado de tipo {@link CategoryResponse}.</p>
 *
 ...
 * directamente la entidad de dominio ni sus dependencias internas.</p>
 *
...
public class FixedExpenseResponse {
     ...
     *
     * <p>Corresponde a un valor del enumerado {@link Frequency} que indica
     ...
     *
     * <p>Representa el valor económico del gasto recurrente. Se utiliza
     ...
     *
     * <p>Corresponde a un valor del enumerado {@link Status} que indica
     ...
     *
     * <p>Indica hasta cuándo está vigente el gasto recurrente en el sistema.
     * Se representa como {@link LocalDate} sin información de hora
     * ni zona horaria, dado que la vigencia opera a nivel de día calendario.</p>
     */
     ...
     * Si el gasto fijo no tiene categoría asociada, este campo será {@code null}.</p>
     */

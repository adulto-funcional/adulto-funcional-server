...
// import
// org.adultofuncional.main.account.application.usecase.GetAccountUseCase;
// import
// org.adultofuncional.main.account.application.usecase.UpdateAccountUseCase;
...
// *
// * <p>
// * Este enfoque carga solo la capa web (controladores, validación, conversión
// de
// * mensajes)
...
//
// @Test
// @DisplayName("GET /api/account/{id} debe retornar 200 con los datos de la
// cuenta cuando existe")
...
//
// @Test
// @DisplayName("GET /api/account/{id} debe retornar 404 cuando la cuenta no
// existe")
// void getAccount_shouldReturn404WhenAccountNotFound() throws Exception {
// UUID accountId = UUID.randomUUID();
//
// given(getAccountUseCase.execute(accountId))
// .willThrow(new NotFoundException("Cuenta no encontrada con id: " +
// accountId));
//
// mockMvc.perform(get("/api/account/{id}", accountId)
// .accept(MediaType.APPLICATION_JSON))
...
// .andExpect(jsonPath("$.message").value("Cuenta no encontrada con id: " +
// accountId))
// .andExpect(jsonPath("$.data").doesNotExist());
// }
//
// @Test
// @DisplayName("GET /api/account/{id} debe retornar 500 cuando el ID tiene
// formato inválido")
...
//
// @Test
// @DisplayName("PATCH /api/account/{id} debe retornar 200 con los datos
// actualizados")
...
// .build();
//
// given(updateAccountUseCase.execute(eq(accountId),
...
//
// @Test
// @DisplayName("PATCH /api/account/{id} debe retornar 404 cuando la cuenta no
// existe")
...
//
// @Test
// @DisplayName("PATCH /api/account/{id} debe retornar 400 cuando el email ya
// está registrado")
...
// given(updateAccountUseCase.execute(eq(accountId),
// any(UpdateAccountRequest.class)))
// .willThrow(new BusinessException("El email existing@example.com ya está
...
// .andExpect(jsonPath("$.message").value("El email existing@example.com ya está
// registrado por otra cuenta"));
// }
//
// @Test
// @DisplayName("PATCH /api/account/{id} debe retornar 400 cuando el request
// tiene campos vacíos")
// void updateAccount_shouldReturn400WhenRequestHasBlankFields() throws
// Exception {
// UUID accountId = UUID.randomUUID();
// UpdateAccountRequest request = UpdateAccountRequest.builder()
// .names("")
...
//
// @Test
// @DisplayName("PATCH /api/account/{id} debe retornar 400 cuando el email tiene
// formato inválido")
...
//
// @Test
// @DisplayName("PATCH /api/account/{id} debe retornar 400 cuando el nombre
...
// .accept(MediaType.APPLICATION_JSON))
// .andExpect(status().isBadRequest())
// .andExpect(jsonPath("$.data.names").value("El nombre no puede exceder 50
// caracteres"));
// }
//
// @Test
// @DisplayName("DELETE /api/account/{id} debe retornar 204 al eliminar una
// cuenta")
...
//
// @Test
// @DisplayName("GET /api/account/{id} no debe exponer password ni masterKey en
// la respuesta")
...
//
// @Test
// @DisplayName("GET /api/account/{id} debe llamar al use case con el ID
// correcto")
...
//
// @Test
// @DisplayName("PATCH /api/account/{id} debe llamar al use case con el ID y
// request correctos")
...
// .andExpect(status().isOk());
//
// verify(updateAccountUseCase).execute(eq(accountId),
// any(UpdateAccountRequest.class));
// }
// }
